...
reshaped_dims = np.reshape(biaslist, (-1, 5)).shape

# first plot SURF
im_arr = []

for bias in biaslist:
    im_arr.append(plt.imread('cropped-O-DO{:1.4f}-surf.tga'.format(bias)))
...
for bias in biaslist:
    im_arr.append(plt.imread('cropped-O-DO{:1.4f}-vdw.tga'.format(bias)))
