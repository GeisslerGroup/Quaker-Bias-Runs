...
# ------------------ starting from theta_z = -0.6500 rad
im_arr = []

im_arr.append(plt.imread('cropped-mid-a-g-start-surf.tga'))
im_arr.append(plt.imread('cropped-mid-a-g-surf.tga'))
im_arr.append(plt.imread('cropped-mid-a-g-start-vdw.tga'))
im_arr.append(plt.imread('cropped-mid-a-g-vdw.tga'))
...
subplot = fig.add_subplot(2, 2, 1)
subplot.imshow(im_arr[0])
subplot.set_title(r'$\textrm{starting configuration}$', fontsize=20)
subplot.axis('off')

subplot = fig.add_subplot(2, 2, 2)
subplot.imshow(im_arr[1])
subplot.set_title(r'$\textrm{final configuration}$', fontsize=20)
subplot.axis('off')
